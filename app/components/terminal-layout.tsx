...
export function TerminalLayout({ children, className }: TerminalLayoutProps) {
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className={cn("w-full max-w-3xl h-[600px] bg-black border border-green-500 rounded-lg p-4 flex flex-col", className)}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <div className="text-sm ml-2 text-green-500">terminal</div>
        </div>
